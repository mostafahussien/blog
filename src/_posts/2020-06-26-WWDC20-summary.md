...
![]({{ '/assets/img/2020-06-26-WWDC20-summary/translate.jpg' | relative_url }})
...
- [Introducing App Clips]({% if site.baseurl %}{{ site.baseurl }}{% endif %}{% post_url 2020-06-26-Introducing-App-Clips %})
  <!-- - [Serverless Swift with Lambdas on AWS]({% if site.baseurl %}{{ site.baseurl }}{% endif %}{% post_url 2020-06-23-A-first-look-at-Apples-new-Augmented-Reality-features %}) -->
  <!-- - [What's new in SwiftUI]({% if site.baseurl %}{{ site.baseurl }}{% endif %}{% post_url 2020-06-23-A-first-look-at-Apples-new-Augmented-Reality-features %}) -->
